...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('css/backend/dist/css/adminlte.min.css') }}">
</head>
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="" class="h1"><b>Hotel</b>CHINO</a>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('admin.login') }}" method="POST">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" placeholder="{{ __('messages.email')}}">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('js/backend/dist/js/adminlte.min.js') }}"></script>
</body>
